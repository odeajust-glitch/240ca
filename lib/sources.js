...
// Local to Sarnia / Division 240 — meaningless alongside a Western agreement.
const SARNIA_ONLY = ['mileage_guidelines', 'crew_calling', 'crew_calling_cty'];
...
const SOURCES = [
  ...
  },
  {
    ...
    crafts: [],
    manualOnly: true,
    conflictsWith: ['conductors', 'conductors_addendum', ...SARNIA_ONLY],
  },
  {
    id: 'engineers',
  ...
  },
  {
    ...
    crafts: [],
    manualOnly: true,
    conflictsWith: ['engineers', ...SARNIA_ONLY],
  },
  {
